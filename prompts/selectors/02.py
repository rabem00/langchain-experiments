...
bio_summary_selector = LengthBasedExampleSelector(
    examples=bio_summary_examples,
    example_prompt=bio_summary_prompt,
    max_length=300,
    get_text_length=chat.get_num_tokens   # use tokens instead of characters
)

bio_summary_few_shot_prompt = FewShotPromptTemplate(
    example_selector=bio_summary_selector,
    example_prompt=bio_summary_prompt,
